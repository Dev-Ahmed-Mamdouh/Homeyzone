...
public class NotificationsFragment extends ParentFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setNotificationsList(((MainScreen)getActivity()).getNotifications());
        return view;
    }

    public void setNotificationsList(List notifications) {
        if (!notifications.isEmpty()) {
            list_notifications.setAdapter(new NotificationAdapter(notifications,R.layout.adapter_notification, getContext()));
