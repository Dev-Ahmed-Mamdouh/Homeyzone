...
public class FanFragment extends ParentFragment implements View.OnClickListener {

    View view;
    ImageView image;
    SeekArc fanSeekArc;
    int fanSpeed = 50;
    ImageButton fanPower;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fanPower = view.findViewById(R.id.fan_power);
        fanPower.setOnClickListener(this);
        fanIncrease = view.findViewById(R.id.fan_increase);
        fanIncrease.setOnClickListener(this);
        fanDecrease = view.findViewById(R.id.fan_decrease);
        fanDecrease.setOnClickListener(this);
        fanSeekArc = view.findViewById(R.id.seekArc);
        txt_status = view.findViewById(R.id.txt_status);
        fanIncrease.setEnabled(false);
        fanDecrease.setEnabled(false);
        image = (ImageView) view.findViewById(R.id.fan);
        ...
        fanPower.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
    ...
    private void turnOnOff(boolean onOrOff) {
        if (onOrOff) {
            fanPower.setImageDrawable(getResources().getDrawable(R.drawable.btn_on));
            fanDecrease.setBackground(getResources().getDrawable(R.drawable.bg_button_decrease_on));
            fanIncrease.setBackground(getResources().getDrawable(R.drawable.bg_button_increase_on));
        } else {
            fanPower.setImageDrawable(getResources().getDrawable(R.drawable.btn_off));
            fanDecrease.setBackground(getResources().getDrawable(R.drawable.bg_button_decrease_off));
            fanIncrease.setBackground(getResources().getDrawable(R.drawable.bg_button_increase_off));
        }
        fanSeekArc.setPowered(onOrOff);
        fanIncrease.setEnabled(onOrOff);
        fanDecrease.setEnabled(onOrOff);
    ...
    private void getPowerStatus() {
        ((MainScreen) requireActivity()).getDbHelper().listen(new DatabaseHelper.onGetListener() {
            ...
            public void onKeyNotFound(String value) {
                ...
                fanPower.setImageDrawable(getResources().getDrawable(R.drawable.btn_undetermined));
                turnOnOff(false);
    ...
    private void setFanSpeed(int newFanSpeed) {
        ...
        fanSeekArc.setProgress(fanSpeed);
    }
